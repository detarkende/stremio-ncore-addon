...
import { UpdateUserFields } from '@client/components/form/field-groups/update-user-fields';
...
import { updateUserSchema, type UpdateUserRequest, type User } from '@server/exports';
